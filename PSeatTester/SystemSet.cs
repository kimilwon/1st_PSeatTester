...
namespace PSeatTester
{
    public partial class SystemSet : Form
    {
        ...
        private void SystemSet_Load(object sender, EventArgs e)
        {
            ...
            if ((0 <= mControl.GetConfig.Panel.Speed) && (0 < axComboBox1.ListCount) && (mControl.GetConfig.Panel.Speed < axComboBox11.ListCount)) axComboBox1.ListIndex = mControl.GetConfig.Panel.Speed;
            ...
            if ((0 <= mControl.GetConfig.Power.Speed) && (0 < axComboBox5.ListCount) && (mControl.GetConfig.Power.Speed < axComboBox11.ListCount)) axComboBox5.ListIndex = mControl.GetConfig.Power.Speed;



            if (mControl.GetConfig.SmartIOPort.Port != "")
            {
                if (PortName.Contains(mControl.GetConfig.SmartIOPort.Port) == true)
                {
                    int Pos = axComboBox8.FindItem(0, mControl.GetConfig.SmartIOPort.Port, true);
            ...
            if ((0 <= mControl.GetConfig.SmartIOPort.Speed) && (0 < axComboBox7.ListCount) && (mControl.GetConfig.SmartIOPort.Speed < axComboBox7.ListCount)) axComboBox7.ListIndex = mControl.GetConfig.SmartIOPort.Speed;
            ...
            checkBox2.Checked = mControl.GetConfig.IMSSeatToCanControl;
            checkBox3.Checked = mControl.GetConfig.UseSmartIO;

            Num = mControl.GetConfig.KalmanSpeed.ToString("0.00");
            comboBox1.SelectedItem = Num;
            return;
        }
        ...
        private void MoveSpec()
        {
            ...
            if (0 <= axComboBox8.ListIndex) Config.SmartIOPort.Port = axComboBox8.Text;
            if (0 <= axComboBox7.ListIndex) Config.SmartIOPort.Speed = axComboBox7.ListIndex;
            ...
            Config.IMSSeatToCanControl = checkBox2.Checked;
            Config.UseSmartIO = checkBox3.Checked;
